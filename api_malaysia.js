var spec = {
  ...
  "title": "Air Pollution Index (API) in Malaysia on 2022-05-07",
  "width": 800,
  "height": 500,
  "projection": {
    "type": "mercator",
  ...
  "layer": [
    ...
    {
      "data": {
        "url": "https://raw.githubusercontent.com/william22288/air-pollution-index/refs/heads/main/APIMS-transformed(cleaned%20kaggle%20dataset).csv"
      },
      "transform": [
        {
          "lookup": "Location",
      ...
      "encoding": {
        ...
        "size": {
          ...
          "type": "quantitative",
          "title": "Population",
          "scale": {"domain": [100000, 800000], "range": [50, 2000]}
        },
        "color": {
...
vegaEmbed('#symbol_map', spec).then(function(result) {
  // Access Vega view instance if needed
}).catch(console.error);
